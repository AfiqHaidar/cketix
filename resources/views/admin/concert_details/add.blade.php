...
<div class="relative flex justify-center overflow-x-auto  sm:rounded-lg">
    <div class="w-1/3 p-10 bg-[#1A1A1A] shadow-lg rounded-lg flex-col justify-center items-center">
        ...
        <form method="POST" action="{{ route('admin.createConcertDetails') }}"  enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="date" id="date" name="date" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg  block w-full p-2.5">
                @error('date')
            ...
            <div class="mb-6">
                ...
                <select id="venue_id" name="venue_id" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5">                    
