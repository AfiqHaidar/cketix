    ...
    <div class="w-screen mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 ">
            <div class="flex">
             ...
             <!-- Logo -->
             <div class="font-bold shrink-0 flex items-center sm:mr-20">
            ...
            <div class="hidden sm:flex sm:items-center mr-5">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-white/10 hover:scale-110 focus:outline-none transition ease-in-out duration-150">
