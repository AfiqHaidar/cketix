 ...
 <aside id="separator-sidebar" class="w-1/5" aria-label="Sidebar">
    <div class="h-fit rounded-xl px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       ...
       <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
        <li>
           <a href="{{ route('profile.ticket') }}" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
       ...
       <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
          <li>
             <a href="{{ route('profile.transaction') }}" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                ...
                <span class="ms-3">Transaction History</span>
             </a>
          </li>
       </ul>
    </div>
